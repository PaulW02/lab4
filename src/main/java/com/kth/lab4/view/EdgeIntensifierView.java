...
public class EdgeIntensifierView implements IImageView{
    ...
    private void addEventHandlers(ImageController controller) {
        blurBtn.setOnAction((ActionEvent event) -> imageView.setImage(ImagePixelMatrixConverter.getImage(controller.intensifyImageEdges())));
    }
}
